...
<template>
  <FormCollection name="projects">
    <template #default="{ items, keys, canAppend, append, remove, move }">
...
```vue
<Form :form="form">
  <template #default="{ form: formApi, submit, processing }">
    <form @submit.prevent="submit()">
      <FormWizard>
        <template
          #default="{ current, isFirst, isLast, previous, next, labels }"
        >
